...
/**
  ...
  */
Shader::Shader() : m_init(false), m_vp(0), m_fp(0), m_id(0) {
}
...
/**
  ...
  */
Shader::Shader(const char *vsFile, const char *fsFile) : m_init(false), m_vp(0), m_fp(0), m_id(0) {
    init(vsFile, fsFile);
}
...
void Shader::printProperties() const {
    ...
    for (i=0; i < nAttribs; ++i) {
        ...
        std::cerr << loc << ": Attribute"<<i<<":\""<<name<<"\" (Size:"<<size<<" Type:";
        switch(type) {
        case GL_FLOAT: std::cerr << "GL_FLOAT\n"; break;
        case GL_FLOAT_VEC2: std::cerr << "GL_FLOAT_VEC2"; break;
        case GL_FLOAT_VEC3: std::cerr << "GL_FLOAT_VEC3"; break;
        case GL_FLOAT_VEC4: std::cerr << "GL_FLOAT_VEC4"; break;
        case GL_FLOAT_MAT2: std::cerr << "GL_FLOAT_MAT2"; break;
        case GL_FLOAT_MAT3: std::cerr << "GL_FLOAT_MAT3"; break;
        case GL_FLOAT_MAT4: std::cerr << "GL_FLOAT_MAT4"; break;
        case GL_FLOAT_MAT2x3: std::cerr << "GL_FLOAT_MAT2x3"; break;
        case GL_FLOAT_MAT2x4: std::cerr << "GL_FLOAT_MAT2x4"; break;
        case GL_FLOAT_MAT3x2: std::cerr << "GL_FLOAT_MAT3x2"; break;
        case GL_FLOAT_MAT3x4: std::cerr << "GL_FLOAT_MAT3x4"; break;
        case GL_FLOAT_MAT4x2: std::cerr << "GL_FLOAT_MAT4x2"; break;
        case GL_FLOAT_MAT4x3: std::cerr << "GL_FLOAT_MAT4x3"; break;
